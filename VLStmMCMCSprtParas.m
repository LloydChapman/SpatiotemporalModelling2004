function VLStmMCMCSprtParas(db,r1,a,b,u,beta0,alpha0,epsilon0,delta0,h0,typ,inclLST,niters,plotOutpt,rslts)
...
if nargin==0
    ...
    rslts='MCMC_NBIP_SPRT_PARAS.mat'; % name of results file for output
end
...
% Make index vectors of individuals living in each para
i1=(data.Para==1);
i2=(data.Para==2);
i3=(data.Para==3);
j1=(i2|i3);
...
[K,K0old]=KnlSprtParas(d,alpha0,typ,n,i1,i2,i3,j1,j2,j3); % spatial kernel
