function LL=RecalclogLSprtParas(n,tmax,I,RL,tE,tI,tRorD,tRL,tRLR,preB,tDm,prevK,IP,r1,p1,h0,d,d0,beta,alpha,epsilon,delta,typ,tLm,i1,i2,i3,j1,j2,j3)
tEm=false(n,tmax);
tEm((tE-1)*n+I)=1;
if isempty(tLm)
...
K=KnlSprtParas(d,alpha,typ,n,i1,i2,i3,j1,j2,j3);
